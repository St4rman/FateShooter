...
#include "ProjectFateWeaponComponent.generated.h"

class AProjectFateCharacter;

UCLASS(Blueprintable, BlueprintType, ClassGroup=(Custom), meta=(BlueprintSpawnableComponent) )
class PROJECTFATE_API UProjectFateWeaponComponent : public USkeletalMeshComponent
{
	GENERATED_BODY()
